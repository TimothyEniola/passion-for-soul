  ...
  const givingOptions = [
    {
      ...
      description:
        "Give your tithes and offerings to support the work of the ministry.",
      link: "#",
    },
    {
      icon: Building,
    ...
    },
    {
      ...
      description:
        "Support our missionaries and outreach programs around the world.",
      link: "#",
    },
    {
      icon: Gift,
      ...
      description:
        "Give towards specific projects and initiatives in the church.",
      link: "#",
    },
  ];
    ...
    <div className="pt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="bg-[#f8f9fa] rounded-2xl p-12 mb-12">
          <h2 className="text-3xl font-bold text-[#011F5B] mb-8 text-center">
            Why Give?
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-[#718096]">
                Your gifts enable us to spread the gospel and serve our
                community.
              </p>
            </div>
            <div className="text-center">
        ...
        {/* Payment Methods */}
        <div className=" from-[#011F5B] to-[#00356B] rounded-2xl p-12 text-white text-center">
          <h2 className="text-3xl font-bold mb-6">Secure & Easy Giving</h2>
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            We accept various payment methods to make your giving experience
          ...
          <p className="text-sm text-white/70">
            All transactions are encrypted and secure. Your information is safe
            with us.
          </p>
        </div>
      </div>
